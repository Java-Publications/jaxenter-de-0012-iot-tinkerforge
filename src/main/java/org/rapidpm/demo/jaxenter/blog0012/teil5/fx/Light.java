package org.rapidpm.demo.jaxenter.blog0012.teil5.fx;
...
public class Light implements Runnable {
    ...
    public Light(final String UID, final XYChart.Series series, int callbackPeriod) {
        this.UID = UID;
    ...
    public void run() {
        ...
        try {
            ...
            bricklet.addIlluminanceListener(illuminance -> {
                ...
                Platform.runLater(() -> {
                    final XYChart.Data data = new XYChart.Data(new Date(), lux);
                    seriesData.add(data);
                });
            });
